...
Welcome to the YOLOv8 Int8 TFLite Runtime for efficient and optimized object detection. This repository provides comprehensive instructions for installing and using this YOLOv8 implementation, maintained by Deepak Rambarki.
...
Deepak is an AI Engineer with professional experience in designing and maintaining scalable data pipelines and machine learning systems. With expertise in Python, TensorFlow, and PyTorch, he focuses on building high-performance models and cloud-native data platforms that support complex analytics and real-time processing.