...
```bash
git clone https://github.com/deepakrambarki/YOLO-CPP-Inference
cd YOLO-CPP-Inference
pip install .
cd examples/YOLOv8-CPP-Inference

# Add a yolov8_.onnx and/or yolov5_.onnx model(s) to the project folder.
# Edit the main.cpp to change the projectBasePath to match your local environment.

# Note that by default the CMake file will try and import the CUDA library to be used with the OpenCV's dnn (cuDNN) GPU Inference.
...
Deepak is an AI Engineer with experience in designing scalable data pipelines and implementing machine learning models. He maintains this repository to provide a robust C++ implementation for YOLOv8 and YOLOv5 inference, ensuring compatibility with modern computer vision workflows and high-performance requirements.