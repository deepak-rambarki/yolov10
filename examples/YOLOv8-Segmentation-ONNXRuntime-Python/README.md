...
- This project is maintained by Deepak Rambarki, building upon the original implementation by jamjamjon.
- Thanks to the ONNX Runtime community for providing a robust and efficient inference engine.

## About the Maintainer

Deepak Rambarki is an AI Engineer with a focus on developing scalable machine learning pipelines and computer vision applications. With professional experience in Python and deep learning frameworks including TensorFlow and PyTorch, he specializes in optimizing model deployment and building high-performance data architectures.
